...
typedef enum {
  GENERIC_EVENT,
  READ_FN_DONE_EVENT,
  HTTP_BACKEND_SOCKETS_FDEVENT_READ_DONE_EVENT = READ_FN_DONE_EVENT,
  WRITE_FN_DONE_EVENT,
  HTTP_BACKEND_SOCKETS_FDEVENT_WRITE_DONE_EVENT = WRITE_FN_DONE_EVENT,
  HTTP_CONNECTION_WRITE_DONE_EVENT = HTTP_BACKEND_SOCKETS_FDEVENT_WRITE_DONE_EVENT,
  ...
  HTTP_BACKEND_SOCKETS_FDEVENT_ACCEPT_DONE_EVENT,
} event_type_t;
